...
class NessieLoss(nn.Module):
    def __init__(self, Q_predict:Q_predict):
...
class NessieKLDivLoss(NessieLoss):
    def __init__(self, Q_predict:Q_predict):
        super(NessieKLDivLoss, self).__init__(Q_predict)
...
class NessieHellingerDistance(NessieLoss):
    def __init__(self, Q_predict:Q_predict):
        super(NessieHellingerDistance, self).__init__(Q_predict)
...
class NessieLossGeneral(NessieLoss):
    def __init__(self, Q_predict:Q_predict):
        super(NessieLossGeneral, self).__init__(Q_predict)
